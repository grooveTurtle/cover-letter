...
export default function SideProject2() {
  return (
    <div id="main-side-project-detailed" className="section mt-8 print:mt-4">
      <h2 className="mb-6 text-xl font-bold text-gray-800 dark:text-neutral-200 print:text-lg print:mb-4">
        Side Projects
      </h2>
      ...
      <div className="space-y-8 print:space-y-6">
        {detailedSideProjects.map((project, idx) => (
          <div
            key={idx}
            className="border border-gray-200 rounded-lg dark:border-neutral-700 p-6 print:border-gray-400 print:p-4"
          >
            {/* Project Overview */}
            <div className="mb-6 print:mb-4">
              <h3 className="text-lg font-semibold text-gray-800 dark:text-neutral-200 mb-2 print:text-base print:mb-1">
                {project.title}
              </h3>
              <div className="text-sm text-gray-600 dark:text-neutral-400 mb-3 print:text-xs print:mb-2">
                기간: {project.period}
              </div>
              <div className="text-sm text-gray-600 dark:text-neutral-400 mb-3 print:text-xs print:mb-2">
                URL:&nbsp;
              ...
              <p className="text-sm text-gray-700 dark:text-neutral-300 print:text-xs">
                {project.summary}
              </p>
            </div>
            ...
            {/* Project Motivation */}
            <div className="mb-6 print:mb-4">
              <h4 className="text-base font-medium text-gray-800 dark:text-neutral-200 mb-3 print:text-sm print:mb-2">
                📋 프로젝트 진행 동기
              </h4>
              <ul className="space-y-2 print:space-y-1">
                {project.motivation.map((motivation, i) => (
                  <li
                    key={i}
                    className="text-sm text-gray-700 dark:text-neutral-300 print:text-xs"
                  >
                    • {motivation}
                  </li>
                ))}
            ...
            <div className="mb-6 print:mb-4">
              ...
              <div className="space-y-4 print:space-y-2">
                {project.techStack.map((category, i) => (
                  <div key={i}>
                    <h5 className="text-sm font-medium text-gray-700 dark:text-neutral-300 mb-2 print:text-xs print:mb-1">
                      {category.category}
                    </h5>
                    <div className="flex flex-wrap gap-3 print:gap-2">
                      {category.technologies.map((tech, j) => (
                        <div
                          key={j}
                          className="flex items-center gap-2 px-2 py-1 bg-gray-100 dark:bg-neutral-800 rounded-md print:bg-white print:border print:border-gray-300"
                        >
                          <span className="print:hidden">{tech.icon}</span>
                          <span className="text-xs text-gray-700 dark:text-neutral-300 print:text-xs">
                            {tech.label}
                          </span>
                        </div>
                      ))}
              ...
              {project.githubRepo && (
                <div className="mt-4 print:mt-2">
                  <div className="flex items-center gap-2 text-sm text-gray-600 dark:text-neutral-400 print:text-xs">
                    <FaGithub size={16} className="print:hidden" />
                    <span className="print:hidden">GitHub Repository: </span>
            ...
            <div className="mb-6 print:mb-4">
              ...
              <div className="mb-4 print:mb-2 ">
                <h5 className="text-sm font-semibold text-green-700 dark:text-green-400 mb-2 print:text-xs print:mb-1 flex items-center gap-2">
                  <span>✅ 개발 완료</span>
                </h5>
                <div className="space-y-2 print:space-y-1">
                  {project.features
                    ...
                    .map((feature, i) => (
                      <div key={i}>
                        <h6 className="text-sm font-medium text-gray-800 dark:text-neutral-200 mb-1 print:text-xs print:mb-0">
                          • {feature.title}
                        </h6>
                        {feature.description.length > 0 && (
                          <div className="ml-4 print:ml-2">
                            {feature.description.map((desc, j) => (
                              <p
                                key={j}
                                className="text-sm text-gray-600 dark:text-neutral-400 mb-0 print:text-xs"
                              >
                                {desc}
                              </p>
                            ))}
                ...
                {/* Planned Features */}
                <div className="mt-4">
                  <h5 className="text-sm font-semibold text-blue-700 dark:text-blue-400 mb-2 print:text-xs print:mb-1 flex items-center gap-2">
                    <span>🔄 개발 예정</span>
                  </h5>
                  <div className="space-y-2 print:space-y-1">
                    {project.features
            ...
            {project.structure && (
              <div className="mb-6 print:mb-4 print:break-before-page">
                ...
                {project.structure.codeStructure && (
                  <div className="">
                    <div className="bg-gray-50 dark:bg-neutral-800 rounded-lg p-4 print:p-2 print:bg-white print:border print:border-gray-300">
                      <pre className="text-xs text-gray-700 dark:text-neutral-300 overflow-x-auto whitespace-pre print:text-xs font-mono leading-relaxed">
                        {project.structure.codeStructure}
                      </pre>
                    </div>
                  </div>
                ...
                {project.structure.description.map((desc, j) => (
                  <p
                    key={j}
                    className="text-sm text-gray-600 dark:text-neutral-400 mb-1 print:text-xs print:mb-0"
                  >
                    {desc}
                  </p>
                ))}
