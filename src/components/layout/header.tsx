...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 inset-x-0 flex flex-wrap md:justify-start md:flex-nowrap z-50 w-full text-sm ">
      <nav className="mt-1 relative max-w-2xl w-full bg-gray-50 border border-gray-200 rounded-[2rem] mx-2 py-2.5 md:flex md:items-center md:justify-between md:py-0 md:px-4 md:mx-auto dark:bg-neutral-800 dark:border-neutral-00">
